...
\usepackage{makecell}
\usepackage{bm}
\usepackage[a4paper,total={150mm,215mm},top=40mm,inner=3cm,outer=3cm,bottom=35mm,twoside,headsep=5mm,footskip=4.5mm]{geometry}
...
\pagenumbering{Roman}
\include{content/abs_zh.tex}
\include{content/abs_en.tex}
\tableofcontents
\include{content/symbols.tex}
...
\include{content/thanks.tex}
\renewcommand{\leftmark}{攻读学位期间发表的学术论文}
\include{content/achievement.tex}

\section*{独创性声明}
\renewcommand{\leftmark}{独创性声明}
